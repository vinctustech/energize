...
case class Table( name: String, columns: List[Column], columnMap: Map[String, Column], resource: Boolean, base: Option[URIPath], mtm: Boolean, ma: Boolean,
									var preparedInsert: PreparedStatement, var preparedFullInsert: PreparedStatement ) {
